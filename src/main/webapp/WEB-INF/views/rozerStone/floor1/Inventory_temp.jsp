...
<body>
    <div class="inventory">
        ...
        <img src="/static/images/rozer/floor1/inventory.png" class="inventoryImage">
    ...
    <!-- 인벤토리에서 돌아가는 버튼 -->
    <div>
        <img src="/static/images/rozer/floor1/Inventory_back.png" class="back_button" onclick="getBack()">
    </div>
