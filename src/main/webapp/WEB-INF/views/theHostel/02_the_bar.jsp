...
<body>
    ...
    <div id="game-container">
        ...
        <!-- 게임 요소들을 이곳에 추가합니다. -->
        <img id="bar-image" src="/static/images/theHostel/barpage/더호스텔바.png" alt="호텔바화면" style="width: 100%; height: 100%;">
        <button id="left-button" class="nav-button" onclick="location.href='/theHostel/left-wall.do';">　</button>
        <button id="right-button" class="nav-button" onclick="location.href='/theHostel/right-wall.do';">　</button>
        <!-- 아이템 버튼 추가 -->
    ...
    <script src="/static/js/theHostel/02_the_bar.js"></script>
    <script src="/static/game/wordle/wordle.js"></script>
