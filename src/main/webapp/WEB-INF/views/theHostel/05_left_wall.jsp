...
<body>
    ...
    <div id="game-container">
        <img id="left-wall-image" src="/static/images/theHostel/leftwall/왼쪽벽.png" alt="Left Wall" style="width: 100%; height: 100%;">
        <button id="left-button" class="nav-button" onclick="location.href='/theHostel/stage.do'">　</button>
        <button id="right-button" class="nav-button" onclick="location.href='/theHostel/the-bar.do'">　</button>
        <!-- 아이템 버튼 추가 -->
    ...
    <script src="/static/js/theHostel/05_left_wall.js"></script>
